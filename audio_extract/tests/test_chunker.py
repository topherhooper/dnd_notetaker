...
class TestAudioChunker:
    ...
    def test_split_large_file(self, mock_run, mock_getsize, mock_duration, mock_verify, chunker, temp_dir):
    ...
    @patch('os.path.getsize')
    @patch('subprocess.run')
    def test_split_with_ffmpeg_error(self, mock_run, mock_getsize, mock_duration, mock_verify, chunker, temp_dir):
    ...
    @patch('os.path.getsize')
    @patch('subprocess.run')
    def test_split_with_unknown_duration(self, mock_run, mock_getsize, mock_duration, mock_verify, chunker, temp_dir):
