    ...
    try:
        ...
        try:
            ...
            tracker.mark_processed(
                str(test_video), status="completed", metadata={"audio_path": str(audio_path)}
            )
            ...
            if tracker.is_processed(str(test_video)):
                ...
                raise Exception("Video not marked as processed")
        ...
        try:
            ...
            # Mark as failed
            tracker.mark_processed(
                str(fake_video), status="failed", metadata={"error": "File not found"}
            )
